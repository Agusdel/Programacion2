...
template<class T> class Lista {
    ...
    public:
        ...
        /*
         * post: devuelve la posición del elemento buscado o 0 si no lo encuentra.
         *       Si hay más de uno, devuelve el primero.
         */
         int esta(T elemento);
...
template<class T> bool Lista<T>::estaVacia() const{
